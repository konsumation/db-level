...
test("create Meter", async t => {
  const database = {};
  const c = new Category("CAT-1", database, { unit: "kWh", fractionalDigits: 2 });
...
test("create Meter with unit", async t => {
  ...
  const c = new Category("CAT-1", database, { fractionalDigits: 2 });
  const m1 = new Meter("M1", c, { serial: "1234567", unit: "m3",fractionalDigits: 3 });
